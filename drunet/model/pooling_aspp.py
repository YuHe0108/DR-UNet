...
def my_model(input_shape, num_classes=1, dims=32, kernel_size=3):
    ...
    center_u_1 = layers.UpSampling2D(2, interpolation='bilinear')(center_32)
    ...
    center_u_2 = layers.UpSampling2D(2, interpolation='bilinear')(center_32)
    ...
    return keras.Model(inputs, out, name='my_model_aspp')
